...
@include('include/header')
   ...
   <main>
                  ...
                  <div class="col-xl-10">
                     <div class="bd-breadcrumb d-flex align-items-center justify-content-center">
                        ...
                        <div class="bd-breadcrumb__content text-center">
                           <h1 class="bd-breadcrumb__title mb-20">Blog With Sidebar</h1>
      ...
      <section class="bd-blog-3-sidebar-area x-clip pb-90">
         <div class="container">
            <div class="row">
               <div class="col-lg-8">
                  <div class="bd-blog-3-sidebar-wrapper mb-60">
                     <div class="row">
                        <div class="col-lg-6 col-md-6">
                           <div class="bd-blog-2 d-flex align-items-end mb-30">
                              ...
                              <div class="bd-blog-2__content">
                                 ...
                                 <h4 class="bd-blog-2__title"><a href="blog.html">
                        ...
                        <div class="col-lg-6 col-md-6">
                           <div class="bd-blog-2 d-flex align-items-end mb-30">
                              <div class="bd-blog-2__thumb">
                                 <img src="assets/img/blog/7.jpg" alt="image not found">
                              </div>
                              <div class="bd-blog-2__content">
                                 <div class="bd-blog-2__meta">
                                    <a href="blog.html">
                        ...
                        <div class="col-lg-6 col-md-6">
                           <div class="bd-blog-2 d-flex align-items-end mb-30">
                              <div class="bd-blog-2__thumb">
                                 <img src="assets/img/blog/8.jpg" alt="image not found">
                              </div>
                              <div class="bd-blog-2__content">
                                 <div class="bd-blog-2__meta">
                                    <a href="blog.html">
                        ...
                        <div class="col-lg-6 col-md-6">
                           <div class="bd-blog-2 d-flex align-items-end mb-30">
                              <div class="bd-blog-2__thumb">
                                 <img src="assets/img/blog/9.jpg" alt="image not found">
                              </div>
                              <div class="bd-blog-2__content">
                                 <div class="bd-blog-2__meta">
                                    <a href="blog.html">
                     ...
                     <div class="row">
                        <div class="col-12">
                           <div class="bd-blog-pagination pt-10">
                              <ul>
                           ...
                           <ul>
                              <li>
                                 <div class="bd-blog-3-latest-content">
                                    <div class="bd-blog-3-latest-thumb">
                                       <a href="blog-details.html"> <img src="assets/img/blog/2.jpg"
                                             alt="img not found!"></a>
                                    </div>
                                    <div class="bd-blog-3-latest-title-wrap">
                                       <h6 class="bd-blog-3-latest-title"><a href="blog-details.html">hey have
                                             specialized blogs in their different
                                             destinations. </a></h6>
                              ...
                              <li>
                                 <div class="bd-blog-3-latest-content">
                                    ...
                                    <div class="bd-blog-3-latest-title-wrap">
                                       <h6 class="bd-blog-3-latest-title"><a href="blog-details.html">We're
                                             changing the
                              ...
                              <li>
                                 <div class="bd-blog-3-latest-content">
                                    <div class="bd-blog-3-latest-thumb">
                                       <a href="blog-details.html"><img src="assets/img/blog/4.jpg"
                                             alt="img not found!"></a>
                                    </div>
                                    <div class="bd-blog-3-latest-title-wrap">
                                       <h6 class="bd-blog-3-latest-title"><a href="blog-details.html">Best
                                             hotel
                                             blogs
