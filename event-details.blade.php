@include('include/header')
   ...
   <main>
               ...
               <div class="col-xl-8 col-lg-7">
                  <div class="bd-event-details-wrapper mb-45">
                     <div class="bd-event-details-thumb img-hover mb-50 revealed">
                        <img src="assets/img/event/event-details-1.jpg" alt="event img">
                     </div>
                     <div class="bd-event-details-content mb-50">
                        ...
                        <div class="bd-event-details-imagbox">
                           <div class="bd-event-thumb img-hover mb-30">
                              <img src="assets/img/event/event-5.jpg" alt="image not found">
                           </div>
                           <div class="bd-event-thumb img-hover mb-30">
                              <img src="assets/img/event/event-6.jpg" alt="image not found">
                           </div>
                        </div>
      ...
      <section class="bd-gallery-area pb-150 mpt-20">
         <div class="container">
